...
@Component({
  selector: 'app-mantshirts-details',
  templateUrl: './mantshirts-details.component.html',
  styleUrl: './mantshirts-details.component.css'
})
export class MantshirtsDetailsComponent implements OnInit {
  ...
  returnToMainPage() {
    this.router.navigate(['clothes/man/man-t-shirts']);
  }
}
