...
@Component({
  selector: 'app-mancoats-details',
  templateUrl: './mancoats-details.component.html',
  styleUrl: './mancoats-details.component.css'
})
export class MancoatsDetailsComponent implements OnInit {
  ...
  returnToMainPage() {
    this.router.navigate(['clothes/man/man-coats']);
  }
}
