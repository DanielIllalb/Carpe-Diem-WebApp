...
@Component({
  selector: 'app-womenpants-details',
  templateUrl: './womenpants-details.component.html',
  styleUrl: './womenpants-details.component.css'
})
export class WomenpantsDetailsComponent implements OnInit{
  ...
  returnToMainPage() {
    this.router.navigate(['clothes/women/women-pants']);
  }
}
