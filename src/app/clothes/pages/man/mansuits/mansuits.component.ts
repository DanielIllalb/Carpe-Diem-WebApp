...
@Component({
  selector: 'app-mansuits',
  templateUrl: './mansuits.component.html',
  styleUrl: './mansuits.component.css'
})
export class MansuitsComponent implements	OnInit {
  clothes!: Clothes[];
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('man-suits'));
