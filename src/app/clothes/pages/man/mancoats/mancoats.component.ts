...
@Component({
  selector: 'app-mancoats',
  templateUrl: './mancoats.component.html',
  styleUrl: './mancoats.component.css'
})

export class MancoatsComponent implements OnInit {
  clothes!: Clothes[];
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('man-coats'));
