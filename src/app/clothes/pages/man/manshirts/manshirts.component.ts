...
@Component({
  selector: 'app-manshirts',
  templateUrl: './manshirts.component.html',
  styleUrl: './manshirts.component.css'
})
export class ManshirtsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('man-shirts'));
