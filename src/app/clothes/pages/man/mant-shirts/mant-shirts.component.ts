...
@Component({
  selector: 'app-mant-shirts',
  templateUrl: './mant-shirts.component.html',
  styleUrl: './mant-shirts.component.css'
})
export class MantShirtsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('man-t-shirts'));
