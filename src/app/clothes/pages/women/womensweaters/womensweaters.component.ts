...
@Component({
  selector: 'app-womensweaters',
  templateUrl: './womensweaters.component.html',
  styleUrl: './womensweaters.component.css'
})
export class WomensweatersComponent implements OnInit {
  clothes!: Clothes[];
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('women-sweaters'));
