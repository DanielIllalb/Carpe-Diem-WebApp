...
@Component({
  selector: 'app-womendresses',
  templateUrl: './womendresses.component.html',
  styleUrl: './womendresses.component.css'
})
export class WomendressesComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('women-dresses'));
