...
@Component({
  selector: 'app-woment-shirts',
  templateUrl: './woment-shirts.component.html',
  styleUrl: './woment-shirts.component.css'
})
export class WomentShirtsComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('women-t-shirts'));
