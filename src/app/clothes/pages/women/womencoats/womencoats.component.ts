...
@Component({
  selector: 'app-womencoats',
  templateUrl: './womencoats.component.html',
  styleUrl: './womencoats.component.css'
})
export class WomencoatsComponent implements OnInit {
  clothes!: Clothes[];
  ...
  ngOnInit(): void {
    this.clothesService.getClothes().subscribe((clothes) => {
      ...
      this.filteredClothes = clothes.filter((cloth) => cloth.type.includes('women-coats'));
